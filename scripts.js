    ...
    */
    const cargarTabla = (misProductos) => {
        ...
        misProductos.forEach(product => {
            ...
            masButton.className = "btn btn-sm btn-outline-primary";
            ...
            menosButton.className = "btn btn-sm btn-outline-secondary";
            ...
            precioTd.textContent = product.price + currency;
            const totalTd = document.createElement('td');
            totalTd.id = "id_" + product.SKU;
            totalTd.textContent = "0 " + currency;
    ...
    fetch("https://jsonblob.com/api/1422976727273103360")
